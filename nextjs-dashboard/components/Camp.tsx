...
const Camp = () => {
  return (
    ...
    justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[600px]'>
    
     <Campsite
         backgroundImage="bg-bg-img-1"
         title="777 Darja Camp "
         subtitle="centeral Ethiopia ,Kebbata"
    ...
    <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6 ">
       <div className=" bg-green-50 p-8 lg:max-w-[500px]
        ...
        "> 
         ...
         To run a Next.js project, you'll need to follow these general steps. 
         Please note that you should have Node.js and npm (Node Package Manager) 
